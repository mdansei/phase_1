...
from resources.alert_rules.alert_rule_schema import AlertRuleCreate, AlertRuleUpdate, AlertRuleResponse
...
def update_alert_rule(
    ...
    updated_rule = AlertRuleService.update_alert_rule(rule_id=rule_id, rule=alert_rule, session=db)
    if not updated_rule:
        raise HTTPException(status_code=404, detail="Alert rule not found")
    return updated_rule
