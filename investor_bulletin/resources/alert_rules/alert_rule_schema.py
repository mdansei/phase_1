...
class AlertRuleBase(BaseModel):
    ...
    threshold_price: float = Field(..., gt=0, description="Price threshold that triggers the alert")
...
class AlertRuleUpdate(BaseModel):
    ...
    threshold_price: float | None = Field(None, gt=0, description="Price threshold that triggers the alert")
